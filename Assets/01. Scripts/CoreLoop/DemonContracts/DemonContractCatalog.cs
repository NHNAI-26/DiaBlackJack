        ...
        private static DemonContractDefinition[] CreateDefaultDefinitions()
        {
            ...
            return new[]
            {
                new DemonContractDefinition(
                    ...
                    baseSoulCost,
                    "<b>스탠드</b>할 수 없으며 어떤 이유로도 <b>버스트</b>하지 않습니다.\n" +
                    "자신의 차례에 일반 행동 대신, 사탄의 능력을 사용하고 차례를 끝낼 수 있습니다.\n" +
                    "사탄의 능력은 사탄이 향하는 방향에 따라 달라지며, 능력을 쓸 때마다 방향을 바꿉니다.\n\n" +
                    "<b><color=#3B82F6>정방향: 숫자 2개를 선언합니다. 둘 중 하나라도 상대 비공개 카드와 일치하면 상대를 버스트시킵니다.</color></b>\n" +
                    "<b><color=#8E44AD>역방향: 상대에게 히트를 강제합니다. 버스트하지 않으면 뽑은 카드를 버립니다.</color></b>",
                    "계약 직후 <b>종말 카운트</b>를 4 얻습니다. 자신의 차례를 시작할 때마다 <b>종말 카운트</b>가 1 감소합니다.\n" +
                    "자신의 차례를 시작할 때마다 <b>종말 카운트</b>가 0 이하라면, 영혼 <b><color=#8E44AD>2</color>를 잃습니다.</b>"),
                new DemonContractDefinition(
                    BelphegorKey,
                    "벨페고르",
                    DemonContractKind.Belphegor,
                    baseSoulCost,
                    "<b>히트</b> 전에 덱 위 카드를 확인합니다.\n" +
                    "그 카드를 그대로 뽑거나 덱 아래로 보내고 차례를 끝냅니다.",
                    "상대가 <b>스탠드</b>하면 다음 자신의 차례 종료 시 <b>강제로 스탠드합니다.</b>"),
                new DemonContractDefinition(
                    MammonKey,
                    "마몬",
                    DemonContractKind.Mammon,
                    baseSoulCost,
                    "계약 직후 <color=#3B82F6>주사위</color>를 굴립니다.\n" +
                ...
                new DemonContractDefinition(
                    ...
                    baseSoulCost,
                    "<b>버스트</b>할 때 영혼 1을 지불하고, 양측 공개 카드 1장씩을 골라 버린 뒤 <b>생존합니다.</b>",
                    "자신의 공개 카드가 3장 이하라면 <b>스탠드할 수 없습니다.</b>"),
                new DemonContractDefinition(
                    MephistophelesKey,
                    "메피스토펠레스",
                ...
                new DemonContractDefinition(
                    ...
                    baseSoulCost,
                    "차례 시작 시 <b>스탠드</b>하지 않은 상대에게 <b>히트를 강제할 수 있습니다.</b>",
                    "숫자 7 이하 카드의 효과를 <b>사용할 수 없습니다.</b>"),
                new DemonContractDefinition(
                    AzazelKey,
                    "아자젤",
                    DemonContractKind.Azazel,
                    baseSoulCost,
                    "계약 직후, 자신의 공개 카드 효과를 왼쪽부터 오른쪽 순서로 각각 한 번씩 <b>발동합니다.</b>\n" +
                    "<b>히트할 때마다 위 효과를 반복합니다.</b>",
                    "<b>같은 숫자의 공개 카드</b>가 추가되면 <b>버스트</b>합니다."),
                new DemonContractDefinition(
                    PaimonKey,
                    "파이몬",
