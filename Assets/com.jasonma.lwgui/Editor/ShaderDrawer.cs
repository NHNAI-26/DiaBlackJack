...
namespace LWGUI
{
	...
	public class MainDrawer : MaterialPropertyDrawer
	{
		...
		{
			base.Apply(prop);
			if (!prop.hasMixedValue && (prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Float 
	...
	public class SubDrawer : MaterialPropertyDrawer
	{
		...
		public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
		{
			...
			if (IsVisible())
			{
				...
				{
					Debug.LogWarning(this.GetType() + " does not support this MaterialProperty type:'" + prop.propertyType + "'!");
	...
	public class SubToggleDrawer : SubDrawer
	{
		...
		protected override bool IsMatchPropType() { return prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Float; }
	...
	public class SubPowerSliderDrawer : SubDrawer
	{
		...
		protected override bool IsMatchPropType() { return prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Range; }
	...
	public class KWEnumDrawer : SubDrawer
	{
		...
		public override void Apply(MaterialProperty prop)
		{
			...
			if (!prop.hasMixedValue && (prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Float 
				...
				Helper.SetShaderKeyWord(prop.targets, _keyWords, prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Float ? (int)prop.floatValue : 
#if UNITY_2021_1_OR_NEWER
											prop.intValue
#else
											(int)prop.floatValue
	...
	public class TexDrawer : SubDrawer
	{
		...
		protected override bool IsMatchPropType() { return prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Texture; }
		...
		public override void DrawProp(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
		{
			...
			if (extraProp != null && extraProp.propertyType != UnityEngine.Rendering.ShaderPropertyType.Texture)
			{
				Rect extraPropRect = Rect.zero;
				if (extraProp.propertyType == UnityEngine.Rendering.ShaderPropertyType.Range)
				{
				...
				if (extraProp.propertyType == UnityEngine.Rendering.ShaderPropertyType.Vector)
				{
	...
	public class ColorDrawer : SubDrawer
	{
		...
		protected override bool IsMatchPropType() { return prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Color; }
		...
		public override void DrawProp(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				if (p != null && p.propertyType == UnityEngine.Rendering.ShaderPropertyType.Color)
					cProps.Push(p);
			}
			...
			for (int i = 1; i < count; i++)
			{
				...
				var hdr = (prop.propertyFlags & UnityEngine.Rendering.ShaderPropertyFlags.HDR) != UnityEngine.Rendering.ShaderPropertyFlags.None;
	...
	public class ChannelDrawer : SubDrawer
	{
		...
		protected override bool IsMatchPropType() { return prop.propertyType == UnityEngine.Rendering.ShaderPropertyType.Vector; }
