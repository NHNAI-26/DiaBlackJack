...
> 프로젝트: DiaBlackJack  
> 기록·구현 책임자: 이천서  
> 현재 단계: CU-M01 위협용 해머 현행 규칙 이관 완료
> 다음 단계: 독극물·루시퍼 등 후속 카드 콘텐츠는 별도 작업으로 계획
> 최종 갱신: 2026-07-22

> **현행 기획 이관 결과(2026-07-22):** 위협용 해머의 상대 공개 카드 제거 규칙을 코드·적 AI·GameScene 표시와 테스트에 반영했다. 아래 자신의 공개 카드를 비용으로 사용한 내용과 검증 수치는 당시 구현 이력으로 보존한다.
