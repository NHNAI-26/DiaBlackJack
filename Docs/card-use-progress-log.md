...
> **Notion v0.7 영향 이관(2026-07-29):** EP-R04에서 아스모데우스 제한을 7 이하로 개정하고 해머 6·리볼버 7 제한, 리볼버 8 허용을 검증했다. 기존 CU-M07 전체 631/631은 당시 구현 증거로 유지하며 적별 계약 구성은 DC-R06에 남긴다.
