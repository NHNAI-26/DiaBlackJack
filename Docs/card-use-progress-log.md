...
> 다음 단계: DC-R06 아스모데우스 7 이하 제한 이관
> 최종 갱신: 2026-07-29
...
> **Notion v0.7 영향 기록(2026-07-29):** 아스모데우스 제한은 7 이하로 개정됐지만 현재 코드는 6 이하이며 DC-R06 미착수다. 기존 CU-M07 전체 631/631은 당시 구현 증거로 유지하고 이번 문서 작업에서 Unity 테스트는 실행하지 않았다.
