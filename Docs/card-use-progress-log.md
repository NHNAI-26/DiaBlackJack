...
> 프로젝트: DiaBlackJack  
> 기록·구현 책임자: 이천서  
> 현재 단계: CU-M02 보위 나이프·중간 버스트 현행 규칙 이관 완료
> 다음 단계: 독극물·루시퍼 등 후속 카드 콘텐츠는 별도 작업으로 계획
> 최종 갱신: 2026-07-22

> **현행 기획 이관 결과(2026-07-22):** CU-M01의 위협용 해머 대상 변경에 이어 CU-M02에서 보위 나이프 비버스트 강제 폐기와 공개 합 기반 중간 버스트를 코드·테스트에 반영했다. 아래 해머 비용·나이프 유지 정책 내용과 당시 검증 수치는 구현 이력으로 보존한다.
