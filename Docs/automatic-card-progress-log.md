...
> 다음 단계: EP-R04·EP-R05 뒤 AC-RV02 적 덱·집행자 독극물 주입
> 최종 갱신: 2026-07-29

> **Notion v0.7 영향 기록**
> 새 사기꾼·집행자 덱 수량과 집행자의 매 라운드 플레이어 덱 독극물 1장 추가는 아직 코드에 없다. 기존 AC-00~AC-RV01의 카드 효과·정보 은닉·검증은 과거 완료 증거로 유지하며 새 기능 완료로 소급하지 않는다.
