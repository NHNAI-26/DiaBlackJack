...
> 버전: v0.5
> 현재 단계: 기존 AC-RV01 완료 · Notion v0.7 재명세 완료
> 다음 단계: EP-R04·EP-R05 뒤 AC-RV02 적 덱·집행자 배분 전 독극물 주입
> 최종 갱신: 2026-07-29

> **Notion v0.7 영향 기록**
> 새 사기꾼·집행자 덱 수량과 집행자의 매 라운드 플레이어 덱 독극물 1장 추가는 아직 코드에 없다. 주입은 최초 배분 전 가용 전투 덱 혼합·같은 라운드 드로우·전투 중 누적·종료 제거로 확정했다. 기존 AC-00~AC-RV01의 검증은 과거 완료 증거로 유지한다.
...
| AC-RV02 | 이천서(AI Notion 대조·문서화 보조) | 계획 | 적 덱 수량·집행자 주입 코드와 검증 미착수 |
...
| 날짜 | 작성자 | 변경 |
| --- | --- | --- |
| 2026-07-29 | 이천서 | AC-RV02 독극물 주입 순서·드로우 시점·누적 수명·전투 종료 제거를 확정하고 코드 미착수 상태 유지 |
