...
> 기획·개발 책임자: 이천서  
> 버전: v0.8
> 상태: CU-06·CU-M07 완료 · 아스모데우스 7 이하 제한은 DC-R06 대기
> 최종 갱신: 2026-07-29
...
> **Notion v0.7 계약 제한(2026-07-29):** 아스모데우스 소유자는 숫자 7 이하 수동 카드를 사용할 수 없다. 현재 구현·과거 테스트는 6 이하 제한이므로 DC-R06에서 가용성, 적 행동 후보와 경계값 테스트를 함께 이관한다. CU-M07 레비아탄 흐름은 변경하지 않는다.
