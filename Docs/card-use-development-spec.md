...
> 기획·개발 책임자: 이천서  
> 버전: v0.1  
> 상태: CU-06 완료 · 1차 범위 검증 마감
> 최종 갱신: 2026-07-20

> **현행 기획 이관 안내(2026-07-21):** `Docs/card-use-design.md` v0.2에서 위협용 해머의 대상을 자신의 공개 카드가 아닌 상대의 공개 카드 1장으로 바로잡았다. 아래 자신의 카드 비용 설명은 기존 구현 기록이며, 이번 문서 갱신에서는 코드를 변경하거나 새 동작을 검증하지 않았다.
