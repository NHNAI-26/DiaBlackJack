...
| EUI-01 | 후보 생성·선택 대기 상태 기반 | 대기 | 신규 최소 10개·기존 고정 진행 회귀 |
| EUI-02 | 후보 비교·지정·확정 화면 | 대기 | 신규 최소 7개·실제 선택 화면 |
| EUI-03 | 선택 키의 실제 전투·보상 통합 | 대기 | 신규 최소 8개·일반/엘리트·두 번째 선택·보스 전환 |
| EUI-04 | 일반·엘리트·보스 전투 정보 표시 | 대기 | 신규 최소 10개·실제 등급별 전투 화면 |
