...
> 버전: v0.4
> 현재 단계: EUI-05 과거 완료 · 프로필 재연동 선행 완료
> 다음 단계: RF-01B·RF-02 완료 · RF-03 뒤 RF-04 예상 골드·상점 품질 UI 이관
> 최종 갱신: 2026-07-30

> **현행 계획 변경:** EUI-03~EUI-05의 전투 보상 단계는 과거 완료 이력이다. 새 UI 후속은 무료 카드 보상 표시를 제거하고 프로필별 예상 골드·엘리트 상점 품질·보스 상점 없음 안내를 연결한다.
...
| EUI-R01 | Notion v0.7 영혼·능력·계약 단계 재연동 | EP-R06 완료, UI 대기 | 개정 6종 미리보기·선택·실제 전투 일치 |
| RF-04 연동 | 예상 골드·상점 품질·보스 상점 없음 표시 | RF-01B·RF-02 완료, RF-03 선행 대기 | 3·4·6·7·9·15 골드, 엘리트 품질 안내, 기존 보상 등급 문구 제거, 두 해상도·전체 회귀 |

EUI-R01과 RF-04는 프로필 값이나 골드를 UI에 복제하지 않는다. EP-R04~R06, RF-01B 정산과 RF-02 상점 도메인은 완료됐으며, RF-03의 상점 목적지가 확정된 뒤 Presenter·화면·반복 검증만 수행한다.
...
| 날짜 | 작성자 | 변경 내용 |
| --- | --- | --- |
| 2026-07-30 | 이천서 | 과거 EUI 보상 통합 기록은 보존하고 RF-04에서 무료 보상 등급 문구를 예상 골드·엘리트 상점 품질·보스 상점 없음 안내로 교체하도록 후속 순서를 개정 |
