...
> 다음 단계: RF-01B 완료 · RF-02~RF-03 뒤 RF-04 예상 골드·상점 품질 UI 이관
> 최종 갱신: 2026-07-30
...
| RF-04 연동 | 예상 골드·상점 품질·보스 상점 없음 표시 | RF-01B 완료·RF-02~RF-03 선행 대기 | 3·4·6·7·9·15 골드, 엘리트 품질 안내, 기존 보상 등급 문구 제거, 두 해상도·전체 회귀 |

EUI-R01과 RF-04는 프로필 값이나 골드를 UI에 복제하지 않는다. EP-R04~R06과 RF-01B 정산은 완료됐으며, RF-02~RF-03의 상점 목적지가 확정된 뒤 Presenter·화면·반복 검증만 수행한다.
