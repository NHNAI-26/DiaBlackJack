...
> 버전: v0.5
> 상태: 기존 AC-RV01 완료 · Notion v0.7 적 자동 카드 재명세(AC-RV02) 대기
> 최종 갱신: 2026-07-29
...
> 사기꾼은 거짓말 탐지기 3장, 집행자는 독극물 3장·거짓말 탐지기 2장·화염 방사기 2장·회중시계 2장을 가진다. 집행자는 매 라운드 시작에 플레이어 전투 덱에 새 독극물 1장을 추가한다. 현재 프로필 카탈로그의 옛 수량과 라운드 주입 부재는 코드 차이이며 아직 구현·검증하지 않았다.
