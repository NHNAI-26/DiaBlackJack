...
> 작업 식별자: DC-00~DC-08
> 버전: v1.1
> 현재 단계: DC-08 과거 기준 완료, 시작 악마 선택·최대 2장 후보 이관 대기
> 다음 단계: 현행 계약 시작·후보 규칙 구현 및 회귀 검증
> 최종 갱신: 2026-07-26
...
| 최근 자동 기준선 | DC-08 전체 EditMode 397/397 통과 기록 |
...
DC-08까지 우선 악마 4종과 광신도의 자동 선택 기준은 완료됐다. 다음 작업은 실제 사용자의 장시간 플레이 로그로 자동 전투와 다른 체감 난도를 확인하거나, 나머지 악마 중 하나를 별도 작업 ID와 문서 4종으로 착수하는 것이다.
