...
| `Assets/Tests/EditMode/CoreLoop` | 코어 루프·전투 행동·카드 정의·효과 처리 규칙·표시·Controller·반복 회귀 테스트 | CU-06 기준 122개 |
| `Assets/Tests/EditMode/StageProgression` | 진행 상태·전투·표시·전투 행동·런 카드 사용 통합 테스트 | CU-06 기준 34개 |
