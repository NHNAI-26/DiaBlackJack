...
| `Assets/01. Scripts/Runtime/UI/StageProgression` | 진행 표시·입력과 씬 간 Runtime | EUI-02 상대 후보 비교·로컬 집중·선택 상태 화면 유지, RW-04 보상 표시·입력 사용 |
...
| `Assets/06.Packages/Tests/EditMode/StageProgression` | 진행·보상·상대 후보·선택 상태·표시·프로필 전투 변환·호환 테스트 | EUI-02 기준 103개 |
