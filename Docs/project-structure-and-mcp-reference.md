...
| `Assets/01. Scripts/Runtime/StageProgression` | 런·스테이지 순수 상태, 전투 연결과 전투 보상 데이터·런 덱·선택 상태 | RW-02 보류 제안·선택·건너뛰기와 일반/보스 완료 목적지 제공 |
...
| `Assets/06.Packages/Tests/EditMode/StageProgression` | 진행 상태·전투·표시·전투 행동·런 카드 사용·전투 보상 기반/상태 테스트 | RW-02 기준 49개 |
