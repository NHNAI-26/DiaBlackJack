...
| `Assets/Tests/EditMode/CoreLoop` | 코어 루프·전투 행동·카드 정의·효과 처리 규칙·표시·Controller 테스트 | CU-05 기준 117개 |
| `Assets/Tests/EditMode/StageProgression` | 진행 상태·전투·표시·전투 행동·런 카드 사용 통합 테스트 | CU-05 기준 34개 |
