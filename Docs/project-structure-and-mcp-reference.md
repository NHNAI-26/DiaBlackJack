...
| `Assets/01. Scripts/Runtime/StageProgression` | 런·스테이지 순수 상태, 전투 연결과 전투 보상 데이터·런 덱 기반 | RW-01 카탈로그·결정적 제안·덱 추가와 초기화 제공 |
...
| `Assets/06.Packages/Tests/EditMode/StageProgression` | 진행 상태·전투·표시·전투 행동·런 카드 사용·전투 보상 기반 테스트 | RW-01 기준 42개 |
