...
| `Assets/01. Scripts/Runtime/CoreLoop` | 전투 규칙·상태·세션, 전투 행동과 카드 정의·사용·효과 처리 기반 | CU-02 선택 대기·효과 완료 경계까지 제공 |
...
| `Assets/Tests/EditMode/CoreLoop` | 코어 루프·전투 행동·카드 정의·효과 처리 규칙·표시·Controller 테스트 | CU-02 기준 87개 |
