...
| `Assets/01. Scripts/Runtime/CoreLoop` | 전투 규칙·상태·세션과 전투 행동 기반 | BA-04 폴드 가능 여부까지 제공 |
...
| `Assets/01. Scripts/Runtime/StageProgression` | 런·스테이지 순수 상태와 전투 연결 | BA-05에서 폴드·체인지 전달·종료 동기화 확장 |
...
| `Assets/Tests/EditMode/CoreLoop` | 코어 루프·전투 행동 규칙·표시·Controller 테스트 | BA-04 기준 55개 |
| `Assets/Tests/EditMode/StageProgression` | 진행 상태·전투·표시·전투 행동 통합 테스트 | BA-05 기준 27개 |
