...
| `Assets/01. Scripts/CoreLoop` | 전투 규칙·상태·세션, 카드 효과와 적 프로필·공개 관측·정책·안전 표시 스냅샷 | AC-04 화염 방사기 순차 폐기·회중시계 재활성화 처리기 추가 |
...
| `Assets/06.Packages/Tests/EditMode/CoreLoop` | 코어 루프·카드 효과·자동 카드 기반·적 프로필·정책·표시 테스트 | AC-04 기준 316개 |
| `Assets/06.Packages/Tests/EditMode/StageProgression` | 진행·보상·상대 후보·선택 상태·표시·프로필 전투 변환·반복 호환 테스트 | AC-04 회귀 기준 129개 |
