...
| `Assets/01. Scripts/Runtime/StageProgression` | 런·스테이지 순수 상태, 전투·보상과 선택 프로필 키 변환 | EP-06 `StageDefinition.CreateForEnemyProfile`·`StageBattleFactory`·프로필 보상 등급 연결 |
...
| `Assets/06.Packages/Tests/EditMode/StageProgression` | 진행·보상·선택 프로필 전투 변환·호환·상태 격리 테스트 | EP-06 기준 81개 |
