...
| 아자젤 | 공개 카드 유입 이벤트가 동일 숫자를 감지해 자동 카드·숫자 버스트보다 먼저 계약 버스트 처리, 계약 즉시와 정상 히트 뒤 사용 완료 공개 수동 카드 재활성화 |
| 연속 처리 | 아스모데우스 강제 히트와 아자젤 버스트가 기존 자동 카드 continuation·사탄 방지·바알제붑 대체 뒤 정확한 소유자 차례로 재개 |
