...
> 작업 식별자: SV-00~SV-06
> 버전: v1.3
> 현재 단계: 시작 악마 2장 자동 지급 저장 기획 재명세 완료
...
> **2026-07-31 기획 변경 기록**
> 시작 악마는 기본 풀에서 서로 다른 2장을 무작위로 모두 지급한다. 선택 화면과 후보 예약은 현행 목표에서 제거한다. 문서만 변경했으며 기존 2장 제안·1장 선택·`StartingDemonSelected` 저장 구현과 검증은 과거 이력으로 보존한다.
