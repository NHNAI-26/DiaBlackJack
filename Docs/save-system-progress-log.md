...
> 다음 단계: RF-01B 승리 정산 뒤 SV-06 무카드보상·상점 체크포인트 통합
> 최종 갱신: 2026-07-30
...
> `PlayerRunState`가 골드를 소유하면서 캡처의 고정 0과 복원의 양수 차단을 제거했다. 현재 골드는 저장·복원되고 새 런 재시작 시 0으로 돌아간다. 이는 RF-01B 승리 정산이나 SV-06 체크포인트 완료를 뜻하지 않는다.
