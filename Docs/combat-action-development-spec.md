...
BA-01 기반 추가 후 CoreLoop 35/35, 전체 EditMode 58/58이 통과했다. BA-02 폴드 테스트 6개 추가 후 CoreLoop 41/41, 전체 64/64가 통과했다. BA-03 착수 직전 전체 64/64를 다시 확인했고, 체인지 테스트 8개를 추가한 뒤 CoreLoop 49/49, 전체 EditMode 72/72가 통과했다.
