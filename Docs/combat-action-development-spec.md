...
BA-01 기반 추가 후 CoreLoop 35/35, 전체 EditMode 58/58이 통과했다. BA-02 착수 직전 전체 58/58을 다시 확인했고, 폴드 테스트 6개를 추가한 뒤 CoreLoop 41/41, 전체 EditMode 64/64가 통과했다.
