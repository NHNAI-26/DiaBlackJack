...
| --- | --- | --- | --- |
| 이천서 | 프로젝트·기획 문서 책임, 전투·진행·카드 시스템 통합 담당 | 규칙 정리, 구조 결정, 구현 통합, 테스트 기준과 완료 기록 관리 | 코어 루프·런 진행·전투 행동·카드 사용 CU-00~CU-06 완료, 전투 보상 RW-00 문서 완료(AI 보조) |
...
코어 루프 1~4단계, 독립 런·스테이지 SP-00~SP-04, 전투 행동 확장 BA-00~BA-05와 카드 사용 CU-00~CU-06의 구현·검증·문서 마감이 완료되었다. 전투 보상은 RW-00 구현 기준 문서가 완료되어 RW-01 착수 가능한 상태다. 최종 기획 적합성과 코드·화면 승인은 이천서가 담당한다.
...
| RW-01 | 보상 카탈로그·결정적 생성·런 덱 추가·초기화 | 이천서(AI 구현·검증 보조) | 대기 |
| RW-02 | 보상 선택 상태·선택·건너뛰기·완료 목적지 | 이천서(AI 구현·검증 보조) | 대기 |
| RW-03 | 전투 결과·세션·다음 전투 덱 연동 | 이천서(AI 구현·검증 보조) | 대기 |
| RW-04 | 진행 화면 표시·선택·건너뛰기 입력 | 이천서(AI 구현·화면·검증 보조) | 대기 |
| RW-05 | 반복 회귀·실제 흐름·기록 마감 | 이천서(AI 구현·검증·기록 보조) | 대기 |
