...
| AC-01 | 자동 카드 정의·공개 유입·보류 선택·연속 처리 기반 | 이천서(AI 구현·검증 보조) | 미착수 |
| AC-02 | 독극물 스탠드·영혼 선택과 라운드 승리 회복 | 이천서(AI 구현·검증 보조) | 미착수 |
| AC-03 | 거짓말 탐지기 선언·소유자 전용 정보·지식 폐기 | 이천서(AI 구현·검증 보조) | 미착수 |
| AC-04 | 화염 방사기 양측 폐기·회중시계 재활성화 | 이천서(AI 구현·검증 보조) | 미착수 |
| AC-05 | 부활초 승패 없는 라운드 초기화 | 이천서(AI 구현·검증 보조) | 미착수 |
| AC-06 | UI·런·보상·적 AI·반복 회귀와 기록 마감 | 이천서(AI 구현·화면·검증·기록 보조) | 미착수 |
