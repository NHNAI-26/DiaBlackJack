...
| --- | --- | --- | --- |
| 이천서 | 프로젝트·기획 문서 책임, 코어 루프 통합 담당 | 규칙 정리, 코어 루프 기획·구조 결정, 구현 통합, 테스트 기준 관리 | 문서 및 코어 루프 1~4단계 기술 완료(AI 보조) |
...
| 2026-07-19 | 런·스테이지 진행 기획 | 진행 시스템을 코어 루프와 분리하고 런 상태, 전투 연결 경계, 작업 분해와 검증 기준 수립 | `Docs/stage-progression-design.md`, `stage-progression-development-spec.md`, `stage-progression-implementation-plan.md`, `stage-progression-progress-log.md` | AI 문서 초안 보조, SP-00에서 구현 기준 확정, 진행 코드 미착수 |
...
아래 항목은 코어 루프와 분리된 신규 작업의 계획이며 아직 구현 기여가 아니다.

| 작업 ID | 작업 | 예정 책임 | 현재 상태 |
| --- | --- | --- | --- |
| SP-00 | 기준 확정과 회귀 기준 기록 | 이천서(AI 검증 보조) | 완료 |
| SP-01 | 런·스테이지 순수 상태 기반 | 이천서(AI 보조) | 미착수 |
