...
| SV-01 | 순수 런 스냅샷·검증 | 이천서(AI 구현·검증 보조) | 미착수 |
| SV-02 | 버전 JSON·원자 파일·백업 복구 | 이천서(AI 구현·검증 보조) | 미착수 |
| SV-03 | 현재 런 캡처·새 세션 복원 | 이천서(AI 구현·검증 보조) | 미착수 |
| SV-04 | 안정 체크포인트·결정적 후보 재현 | 이천서(AI 구현·검증 보조) | 미착수 |
| SV-05 | 새 게임 예약·이어하기·저장 실패 UI | 이천서(AI UI·검증 보조) | 미착수 |
