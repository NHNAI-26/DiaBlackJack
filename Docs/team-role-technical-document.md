...
| --- | --- | --- | --- |
| 이천서 | 프로젝트·기획 문서, 전투 코어·적 프로필·상대 선택·전투 정보 UI·런 저장 통합 담당 | 규칙·구조 결정, Notion v0.7 적 6종 프로필·AI·카드 효과·전투 변환, 상대 선택·등급별 적 정보 UI, 저장·이어하기 Runtime/UI, 테스트·완료 기록 관리 | EP-R05까지 적 일반·엘리트 특수 정책, BA-R01 공통 체인지, AC-RV02 독극물, DC-R06 광신도·집행자 계약 완료; EP-R06 보스 단계·골드/UI/저장 연동 대기(AI 보조) |
...
| EP-R06 | 보스 고정 계약 단계·골드/UI/저장 연동·밸런스 | 이천서(AI 보조 예정) | 미착수 |
...
| DC-R06 | 적별 계약 이관 | 이천서(AI 구현·테스트·검증·기록 보조) | 부분 완료, 아스모데우스·광신도·집행자 완료·보스 단계 대기; EP-R05 전체 655/655 |
