...
| --- | --- | --- | --- |
| 이천서 | 프로젝트·기획 문서, 전투 코어·적 프로필·상대 선택·전투 정보 UI·런 저장 통합 담당 | 규칙·구조 결정, Notion v0.7 적 6종 프로필·AI·카드 효과·전투 변환, 상대 선택·등급별 적 정보 UI, 저장·이어하기 Runtime/UI, 테스트·완료 기록 관리 | 기존 전투·카드·계약·저장 범위 완료 기록 유지, Notion v0.7 기획 전반 재명세 완료; EP-R04~R06·DC-R06·AC-RV02·BA-R01은 구현 대기(AI 보조) |
