...
> 작업 식별자: DC-00~DC-08
> 버전: v1.18
> 상태: DC-R06 광신도·집행자 계약 구성 완료 · 보스 고정 단계 대기
> 최종 갱신: 2026-07-29
...
> 광신도는 첫 정상 차례부터 계약 성공까지 매 정상 차례 계약을 우선하며 영혼·공개 카드 조건으로 벨페고르·바알제붑·벨리알 중 하나를 고른다. 집행자는 파이몬을, 보스는 전투 시작·영혼 5·2에서 바포메트·아스모데우스·아자젤을 고정 단계로 계약한다. 아스모데우스의 7 이하 제한은 EP-R04, 광신도·집행자 구성은 EP-R05에서 공통 가용성·프로필 전투 경계에 이관했다. 현재 DC-R06 변경 대상은 보스 고정 계약 전이뿐이다.
