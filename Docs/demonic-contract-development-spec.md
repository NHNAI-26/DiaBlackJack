...
> 작업 식별자: DC-00~DC-08
> 버전: v1.14
> 상태: DC-R05 완료 · CU-M07 레비아탄 조건부 재예측 검증 통과
> 최종 갱신: 2026-07-29
...
> 사탄은 종말 카운트 4와 활성 계약 카드 자체의 양면 효과로, 마몬 재굴림은 일반 행동을 소비하는 행동으로, 레비아탄은 리볼버 2회 발동으로 변경되었다. 메피스토펠레스는 보위 나이프 결과 21 초과 버스트와 실패 시 자기 비공개 카드 공개를 사용한다. 이 명세의 기존 DC-04·DC-06 완료 문단은 당시 구현 증거이며 새 규칙 구현 완료를 뜻하지 않는다.
