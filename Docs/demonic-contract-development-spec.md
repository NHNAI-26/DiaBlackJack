...
> 작업 식별자: DC-00~DC-08
> 버전: v1.15
> 상태: 기존 DC-R05·CU-M07 완료 · Notion v0.7 적 계약 재명세(DC-R06) 대기
> 최종 갱신: 2026-07-29
...
> 광신도는 벨페고르·바알제붑·벨리알 중 영혼과 공개 카드 조건으로 하나를 선택하고 1~2라운드 안에 계약해야 한다. 집행자는 파이몬을, 보스는 바포메트·아스모데우스·아자젤을 고정 단계로 계약한다. 아스모데우스 제한은 7 이하로 변경한다. 현재 광신도 공용 12종 덱·효용 정책과 6 이하 제한은 구현 이력으로 보존하되 DC-R06의 현행 계약으로 간주하지 않는다.
