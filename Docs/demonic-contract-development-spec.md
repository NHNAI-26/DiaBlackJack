...
> 작업 식별자: DC-00~DC-08
> 버전: v1.17
> 상태: 기존 DC-R05·CU-M07 완료 · EP-R04 아스모데우스 7 이하 제한 이관 완료 · DC-R06 나머지 적 계약 구성 대기
> 최종 갱신: 2026-07-29
...
> 광신도는 첫 정상 차례부터 계약 성공까지 매 정상 차례 계약을 우선하며 영혼·공개 카드 조건으로 벨페고르·바알제붑·벨리알 중 하나를 고른다. 집행자는 파이몬을, 보스는 전투 시작·영혼 5·2에서 바포메트·아스모데우스·아자젤을 고정 단계로 계약한다. 아스모데우스의 7 이하 제한은 EP-R04에서 공통 가용성 코드와 경계 테스트에 이관했다. 현재 광신도 공용 12종 덱·효용 정책과 적별 계약 구성은 DC-R06 변경 대상이다.
