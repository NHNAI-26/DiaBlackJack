...
> 작업 식별자: DC-00~DC-08
> 버전: v1.16
> 상태: 기존 DC-R05·CU-M07 완료 · DC-R06 적 계약 시점 확정·구현 대기
> 최종 갱신: 2026-07-29
...
> 광신도는 첫 정상 차례부터 계약 성공까지 매 정상 차례 계약을 우선하며 영혼·공개 카드 조건으로 벨페고르·바알제붑·벨리알 중 하나를 고른다. 집행자는 파이몬을, 보스는 전투 시작·영혼 5·2에서 바포메트·아스모데우스·아자젤을 고정 단계로 계약한다. 아스모데우스 제한은 7 이하로 변경한다. 현재 광신도 공용 12종 덱·효용 정책과 6 이하 제한은 과거 구현 이력이다.
