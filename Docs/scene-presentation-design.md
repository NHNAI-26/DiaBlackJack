...
- 계약을 승인하면 중앙 공용 영역에 악마 카드 3장을 앞면으로 펼쳐 `발견` 방식으로 제시한다.
...
- 선택하지 않은 두 카드는 악마 버린 카드 더미로 이동한다.
...
- 중앙의 계약 후보 3장 및 후보별 능력·대가 호버 정보
...
- 계약 후보 3장과 선택된 활성 계약 카드의 능력·대가를 호버로 확인할 수 있다.
