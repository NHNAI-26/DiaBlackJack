...
적을 퇴장시키고 같은 자리에 상인을 등장시킨다. 상인은 재고가 각각 1개인 판매 카드 5장, 상점당 1회 휴식과 카드 제거 등 현재 이용 가능한 상품·서비스를 테이블에 펼친다. 구매한 카드는 사라지고 다른 상품은 유지하며 새로고침·재입고는 제공하지 않는다. 아직 미정인 상품 가격과 휴식 회복량은 확정 후 화면 UI와 테이블 가격표에 표시한다.
