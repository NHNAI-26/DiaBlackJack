...
## CP-04 자동카드 결과 줄 수 정리

- 2026-08-09: 부활초와 화염 방사기의 플레이어·적 결정 문장을 같은 줄로
  합쳤다. 자동카드 5종 결과는 명시적 줄바꿈 기준 1~2줄이며, 모든 결과가
  3줄 이하인지 테스트로 고정했다.
- Unity MCP job `8b241b6242e74e85be962fa51aa8b94b`: `CP04` 28/28 통과.
  컴파일 직후 Console 오류 0을 확인했다.
