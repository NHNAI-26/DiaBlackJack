...
| 문서 | 용도 | 상태 |
| --- | --- | --- |
| [rule.md](./rule.md) | 게임 원본 규칙 | 악마 계약 공통 규칙 개정 v0.3 |
| [game-design-document.md](./game-design-document.md) | 전체 게임 기획과 임시 기획 결정 | 계약 공통 규칙 반영 v0.2 |
...
| [demonic-contract-design.md](./demonic-contract-design.md) | 악마 계약 제공·비용·지속·우선 악마 4종의 프로토타입 규칙 | DC-01 기반 구현 완료 v0.3 |
| [demonic-contract-development-spec.md](./demonic-contract-development-spec.md) | 계약 데이터·전투 상태·효과 훅·런 덱·UI·테스트 명세 | DC-01 검증 완료 v0.3 |
| [demonic-contract-implementation-plan.md](./demonic-contract-implementation-plan.md) | DC-00~DC-07 구현 순서와 단계별 검증 게이트 | DC-01 완료·DC-02 예정 v0.3 |
| [demonic-contract-progress-log.md](./demonic-contract-progress-log.md) | 계약 결정·구현·검증 누적 기록 | DC-01 완료, 대상 19/19·전체 329/329 |
