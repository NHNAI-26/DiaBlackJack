...
| [game-design-document.md](./game-design-document.md) | 전체 게임 기획과 임시 기획 결정 | DC-R04 2/5 규칙 반영 v0.9 |
...
| [demonic-contract-design.md](./demonic-contract-design.md) | 악마 계약 제공·비용·지속과 개별 악마 최신 규칙 | DC-R04 2/5 완료 v1.9 |
| [demonic-contract-development-spec.md](./demonic-contract-development-spec.md) | 계약 데이터·전투 상태·효과 훅·런 덱·UI·적 AI·테스트 명세 | 바알제붑 정정·아스모데우스·아자젤 반영 v1.8 |
| [demonic-contract-implementation-plan.md](./demonic-contract-implementation-plan.md) | DC-00~DC-08 이력과 DC-R00~R05 개정 계획 | DC-R04 2/5 완료·파이몬/벨리알 다음 v1.8 |
| [demonic-contract-progress-log.md](./demonic-contract-progress-log.md) | 계약 결정·구현·검증 누적 기록 | 바알제붑 8/8·신규 11/11·전체 579/579 v1.8 |
